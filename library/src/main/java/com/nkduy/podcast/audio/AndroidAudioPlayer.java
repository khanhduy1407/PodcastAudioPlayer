...
public class AndroidAudioPlayer extends AbstractAudioPlayer {
    ...
    public AndroidAudioPlayer(com.nkduy.podcast.audio.MediaPlayer owningMediaPlayer, Context context, String userAgent) {
    ...
    public void setPlaybackSpeed(float f) {
        ...
        PlaybackParams params = mp.getPlaybackParams();
        params.setSpeed(f);
        boolean isPaused = this.owningMediaPlayer.state == com.nkduy.podcast.audio.MediaPlayer.State.PAUSED;
        mp.setPlaybackParams(params);
        if (isPaused) {
            mp.pause();
        }
